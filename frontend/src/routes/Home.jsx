        ...
        <div className="relative mx-auto max-w-2xl py-16">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-fuchsia-950">
              Siliguri Institute of Technology is a private engineering and
              management college, established in 1999 in Siliguri, West Bengal,
              India. Initially the college was under North Bengal University and
              from the year 2004 came under the control of the newly formed West
